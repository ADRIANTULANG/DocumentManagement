...
class DocumentWidget extends GetView<FolderController> {
    ...
    return InkWell(
      onTap: () {
        controller.openFile(
            ...
            path: controller.folderFileList[index].savePath,
            documentID: controller.folderFileList[index].id,
            context: context,
            filename: controller.folderFileList[index].name);
      },
      child: Container(
        child: Obx(
                    ...
                    Stack(
                      ...
                      children: [
                        Container(
                          ...
                          width: 100.w,
                          child: Image.asset(
                              "assets/images/${controller.folderFileList[index].name.split('.').last}.png"),
                        ),
                        Positioned(
                          child: Obx(
