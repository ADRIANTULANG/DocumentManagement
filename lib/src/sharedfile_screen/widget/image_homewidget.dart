...
import 'package:dm/src/sharedfile_screen/widget/image_viewer.dart';
...
import '../alertdialog/sharedfiles_alertdialog.dart';

class ImageWidget extends GetView<SharedFileController> {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () {
        Get.to(() =>
            ImageViewer(imageLink: controller.sharedFilesList[index].url));
      },
      child: Container(
        child: Obx(
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                              image: DecorationImage(
                                  fit: BoxFit.cover,
                                  image: NetworkImage(
                                      controller.sharedFilesList[index].url))),
                        ),
                        Positioned(
                          child: Obx(
